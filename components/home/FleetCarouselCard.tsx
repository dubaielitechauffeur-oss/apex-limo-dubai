      ...
      <div className="mt-auto grid grid-cols-2 gap-3 px-4 pb-5">
        ...
        {whatsapp ? (
          <a
            ...
            className="inline-flex items-center justify-center gap-1.5 rounded-sm bg-[#25D366] px-4 py-2.5 text-xs font-semibold uppercase tracking-wider text-white transition-colors duration-200 hover:bg-[#1EBE5A]"
          >
