      ...
      <div className="mt-auto grid grid-cols-2 gap-3 px-4 pb-5">
        ...
        {whatsapp ? (
          ...
          <Link
            ...
            className={
              isDark
                ? "inline-flex items-center justify-center rounded-lg border border-ivory/30 px-4 py-2.5 text-xs font-semibold uppercase tracking-wider text-ivory transition-colors duration-200 hover:border-ivory hover:bg-ivory hover:text-obsidian"
                : "inline-flex items-center justify-center rounded-lg border border-obsidian/30 px-4 py-2.5 text-xs font-semibold uppercase tracking-wider text-obsidian transition-colors duration-200 hover:border-obsidian hover:bg-obsidian hover:text-ivory"
            }
          >
            Contact Us
          </Link>
