 ...
 * Stays a server component; only the anchor is the client-side `TrackedCta`,
 * so the click is counted as a lead without hydrating the rest.
 *
 * This is the single highest-volume conversion path on the site and was
 * previously invisible to analytics entirely.
 */
