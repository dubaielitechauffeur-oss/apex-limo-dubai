...
export const FLEET: FleetVehicle[] = [
  ...
  },
  {
    ...
    images: [
      {
        src: "/images/fleet/mercedes-v250-falcon/mercedes-v250-falcon-1.jpg",
        alt: {
      ...
      {
        src: "/images/fleet/mercedes-v250-falcon/mercedes-v250-falcon-2.jpg",
        alt: {
      ...
      {
        src: "/images/fleet/mercedes-v250-falcon/mercedes-v250-falcon-3.jpg",
        alt: {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: {
          en: "The Falcon Edition seats up to 6 guests in its VIP lounge configuration, with a dedicated luggage area — ideal for executive groups and VIP delegations travelling together.",
          ar: "تتسع فالكون إديشن لما يصل إلى 6 ضيوف في تكوين صالة كبار الشخصيات، مع منطقة أمتعة مخصصة — مثالية لمجموعات رجال الأعمال ووفود كبار الشخصيات المسافرين معًا.",
          ru: "Falcon Edition вмещает до 6 гостей в VIP-конфигурации лаунджа, с отдельной зоной для багажа — идеально для деловых групп и VIP-делегаций, путешествующих вместе.",
          zh: "猎鹰版在其贵宾休息室配置下最多可容纳6位宾客,并设专属行李区——非常适合共同出行的商务团体及贵宾团。",
          fr: "La Falcon Edition accueille jusqu'à 6 invités dans sa configuration salon VIP, avec un espace bagages dédié — idéale pour les groupes d'affaires et délégations VIP voyageant ensemble.",
          de: "Die Falcon Edition bietet in ihrer VIP-Lounge-Konfiguration Platz für bis zu 6 Gäste, mit einem eigenen Gepäckbereich — ideal für gemeinsam reisende Führungsgruppen und VIP-Delegationen.",
        },
      },
    ],
  },
