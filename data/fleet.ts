...
export const FLEET: FleetVehicle[] = [
  ...
  },
  {
    ...
    description: {
      en: "A spacious, beautifully finished van for group transfers and events — seating for up to seven without sacrificing the comfort of a luxury sedan.",
      ar: "حافلة صغيرة واسعة ومصنعة بعناية فائقة لنقل المجموعات والفعاليات — تتسع لسبعة أشخاص دون التضحية براحة السيدان الفاخرة.",
      ru: "Просторный, безупречно отделанный микроавтобус для групповых трансферов и мероприятий — вмещает до семи человек без потери комфорта, присущего роскошному седану.",
      zh: "宽敞精致的商务车,专为团体接送及活动而设——最多可容纳七人,同时不失豪华轿车般的舒适体验。",
      fr: "Un van spacieux et magnifiquement fini pour les transferts de groupe et les événements — jusqu'à sept places sans sacrifier le confort d'une berline de luxe.",
      de: "Ein geräumiger, hochwertig verarbeiteter Van für Gruppentransfers und Veranstaltungen — Platz für bis zu sieben Personen, ohne auf den Komfort einer Luxuslimousine zu verzichten.",
    },
    longDescription: {
    ...
    whyChoose: {
      ...
      ar: [
        "تتسع لسبعة أشخاص دون ازدحام — مثالية للعائلات والمجموعات الصغيرة",
      ...
      ru: [
        "Вмещает до 7 человек без тесноты — идеально для семей и небольших групп",
      ...
      zh: [
        "最多可容纳7人且毫不局促——是家庭及小型团体的理想之选",
        "行李容量与乘客人数相匹配,满足整个出行团队需求",
        "滑动车门让酒店处的上下车与装卸行李轻松自如",
        "一辆统一协调的座驾,无需协调多辆轿车",
      ],
      fr: [
        "Jusqu'à 7 places sans être à l'étroit — idéal pour les familles et petits groupes",
      ...
      de: [
        "Platz für bis zu 7 Personen ohne Enge — ideal für Familien und kleine Gruppen",
    ...
    faqs: [
      {
        ...
        answer: {
          en: "The V-Class comfortably seats up to 7 passengers with individual captain's chairs, plus a dedicated luggage area.",
          ar: "تتسع V-Class بسهولة لما يصل إلى 7 ركاب بمقاعد فردية، بالإضافة إلى منطقة أمتعة مخصصة.",
          ru: "V-Class комфортно вмещает до 7 пассажиров с индивидуальными капитанскими креслами, плюс специальная зона для багажа.",
          zh: "V级可舒适容纳最多7名乘客,配独立座椅及专属行李区。",
          fr: "La Classe V accueille confortablement jusqu'à 7 passagers avec sièges capitaine individuels, plus un espace bagages dédié.",
          de: "Die V-Klasse bietet bequem Platz für bis zu 7 Passagiere mit individuellen Captain-Seats, plus einem eigenen Gepäckbereich.",
        },
      },
      {
        question: {
  ...
  },
  {
    ...
    images: [
      {
        ...
        alt: {
          ...
          ru: "Чёрный люкс-вэн Mercedes-Benz V250 Falcon Edition, вид спереди сбоку у входа в отель в Дубае",
          zh: "黑色梅赛德斯-奔驰V250猎鹰版豪华商务车,迪拜酒店门口前四分之三视角",
          fr: "Van de luxe Mercedes-Benz V250 Falcon Edition noir, vue avant trois-quarts à l'entrée d'un hôtel à Dubaï",
          de: "Schwarzer Mercedes-Benz V250 Falcon Edition Luxus-Van, Vorderansicht von schräg vorne am Eingang eines Hotels in Dubai",
        },
      },
      {
        src: "/images/fleet/mercedes-v250-falcon/mercedes-v250-falcon-2.webp",
        alt: {
          en: "Mercedes-Benz V250 Falcon Edition VIP cabin with tan quilted leather captain's chairs facing a ceiling entertainment screen",
          ar: "مقصورة كبار الشخصيات في مرسيدس-بنز V250 فالكون إديشن بمقاعد فردية من الجلد المبطن البني تواجه شاشة ترفيه سقفية",
          ru: "VIP-салон Mercedes-Benz V250 Falcon Edition с капитанскими креслами из стёганой светло-коричневой кожи напротив потолочного развлекательного экрана",
          zh: "梅赛德斯-奔驰V250猎鹰版贵宾座舱,棕色绗缝真皮独立座椅正对车顶娱乐屏幕",
          fr: "Cabine VIP de la Mercedes-Benz V250 Falcon Edition avec sièges capitaine en cuir matelassé fauve face à un écran de divertissement au plafond",
          de: "VIP-Kabine des Mercedes-Benz V250 Falcon Edition mit Captain-Seats aus hellbraunem Steppleder gegenüber einem Deckenbildschirm",
        },
      },
      {
        src: "/images/fleet/mercedes-v250-falcon/mercedes-v250-falcon-3.webp",
        alt: {
          en: "Mercedes-Benz V250 Falcon Edition rear lounge in tan leather with entertainment screen, privacy curtains and ambient lighting",
          ar: "صالة مرسيدس-بنز V250 فالكون إديشن الخلفية من الجلد البني مع شاشة ترفيه وستائر خصوصية وإضاءة محيطية",
          ru: "Задний лаундж Mercedes-Benz V250 Falcon Edition в светло-коричневой коже с развлекательным экраном, шторами и атмосферной подсветкой",
          zh: "梅赛德斯-奔驰V250猎鹰版后排休闲舱,棕色真皮配娱乐屏幕、隐私窗帘及氛围灯光",
          fr: "Salon arrière de la Mercedes-Benz V250 Falcon Edition en cuir fauve avec écran de divertissement, rideaux d'intimité et éclairage d'ambiance",
          de: "Hintere Lounge des Mercedes-Benz V250 Falcon Edition in hellbraunem Leder mit Entertainment-Bildschirm, Sichtschutzvorhängen und Ambientebeleuchtung",
        },
      },
    ],
    name: "Mercedes-Benz V250 Falcon Edition",
    category: "Van",
    tagline: {
      en: "Business class, on wheels",
      ar: "درجة رجال الأعمال، على الطريق",
      ru: "Бизнес-класс на колёсах",
      zh: "移动的商务舱",
      fr: "La classe affaires, sur roues",
      de: "Business Class auf Rädern",
    },
    description: {
      en: "A bespoke Falcon Edition conversion of the Mercedes V250 — a private, business-class cabin on wheels with reclining captain's chairs, a ceiling entertainment screen and privacy curtains for VIP guests and executive groups.",
      ar: "تحويل فالكون إديشن المصمم خصيصًا لمرسيدس V250 — مقصورة خاصة بدرجة رجال الأعمال على الطريق، بمقاعد فردية قابلة للاستلقاء وشاشة ترفيه سقفية وستائر خصوصية لكبار الشخصيات ومجموعات رجال الأعمال.",
      ru: "Эксклюзивная переделка Falcon Edition на базе Mercedes V250 — приватный салон бизнес-класса на колёсах с раскладывающимися капитанскими креслами, потолочным развлекательным экраном и шторами для VIP-гостей и деловых групп.",
      zh: "基于梅赛德斯V250的定制猎鹰版改装——移动的私密商务舱,配可躺式独立座椅、车顶娱乐屏幕及隐私窗帘,专为贵宾及商务团体打造。",
      fr: "Une transformation Falcon Edition sur mesure de la Mercedes V250 — une cabine privée de classe affaires sur roues, avec sièges capitaine inclinables, écran de divertissement au plafond et rideaux d'intimité pour invités VIP et groupes d'affaires.",
      de: "Ein maßgefertigter Falcon-Edition-Umbau des Mercedes V250 — eine private Business-Class-Kabine auf Rädern mit verstellbaren Captain-Seats, Decken-Entertainment-Bildschirm und Sichtschutzvorhängen für VIP-Gäste und Führungsgruppen.",
    },
    longDescription: {
      en: "The Mercedes-Benz V250 Falcon Edition takes an already accomplished luxury van and rebuilds the interior as a private business-class lounge. Individual reclining captain's chairs in quilted leather replace ordinary bench seating, each with its own armrests and space to stretch out, so guests arrive rested whether the ride is across town or across the emirate. A ceiling-mounted entertainment screen, ambient lighting and full-length privacy curtains turn the cabin into a mobile meeting room or a quiet retreat — ideal for confidential calls, working between appointments, or simply unwinding away from the street outside. A refrigerated console keeps refreshments cold, onboard Wi-Fi and USB charging keep everyone connected, and the surrounding cabin insulation keeps road noise where it belongs. Every journey is chauffeured by a uniformed professional, with sliding-door access that makes hotel and venue arrivals effortless. For executives, celebrities, and VIP delegations who want the space of a van with the finish of a flagship, the Falcon Edition is the statement vehicle in the fleet.",
      ar: "تأخذ مرسيدس-بنز V250 فالكون إديشن حافلة فاخرة متقنة أصلاً وتعيد بناء مقصورتها الداخلية كصالة خاصة بدرجة رجال الأعمال. تحل المقاعد الفردية القابلة للاستلقاء من الجلد المبطن محل المقاعد العادية، ولكل منها مساند ذراعين خاصة به ومساحة للتمدد، ليصل الضيوف مرتاحين سواء كانت الرحلة عبر المدينة أو عبر الإمارة. تحوّل شاشة الترفيه السقفية والإضاءة المحيطية وستائر الخصوصية الكاملة المقصورة إلى غرفة اجتماعات متنقلة أو ملاذ هادئ — مثالية للمكالمات السرية أو العمل بين المواعيد أو ببساطة الاسترخاء بعيدًا عن الشارع في الخارج. تحافظ الوحدة الوسطى المبردة على برودة المرطبات، وتبقي شبكة الواي فاي وشحن USB الجميع على اتصال، ويبقي عزل المقصورة المحيط ضوضاء الطريق في مكانها. كل رحلة يقودها سائق محترف بزي رسمي، مع أبواب منزلقة تجعل الوصول إلى الفنادق والأماكن سهلاً. لرجال الأعمال والمشاهير ووفود كبار الشخصيات الذين يريدون مساحة حافلة مع تشطيب سيارة رائدة، فإن فالكون إديشن هي السيارة المميزة في الأسطول.",
      ru: "Mercedes-Benz V250 Falcon Edition берёт и без того совершенный люксовый вэн и перестраивает салон в частный лаундж бизнес-класса. Отдельные раскладывающиеся капитанские кресла из стёганой кожи заменяют обычные диваны — у каждого свои подлокотники и место, чтобы вытянуться, так что гости прибывают отдохнувшими, будь то поездка через город или через весь эмират. Потолочный развлекательный экран, атмосферная подсветка и шторы во всю высоту превращают салон в мобильную переговорную или тихое убежище — идеально для конфиденциальных звонков, работы между встречами или просто отдыха вдали от улицы. Охлаждаемая консоль сохраняет напитки холодными, Wi-Fi и USB-зарядка держат всех на связи, а шумоизоляция салона оставляет дорожный шум снаружи. Каждую поездку ведёт профессиональный водитель в униформе, а раздвижные двери делают прибытие к отелям и площадкам легким. Для руководителей, знаменитостей и VIP-делегаций, которым нужен простор вэна с отделкой флагмана, Falcon Edition — знаковый автомобиль автопарка.",
      zh: "梅赛德斯-奔驰V250猎鹰版将本已出色的豪华商务车内舱重新打造为私密的商务舱休息室。绗缝真皮独立可躺座椅取代了普通座椅,每个座位都配有独立扶手和充裕的伸展空间,无论是穿越城市还是横跨酋长国,宾客都能舒适抵达。车顶娱乐屏幕、氛围灯光及全长隐私窗帘将座舱化作移动会议室或宁静空间——非常适合保密通话、会议间隙办公,或只是远离外界街道放松身心。冷藏中控台可保持饮品冰爽,车载WiFi与USB充电让每位乘客保持在线,环绕式车舱隔音则将路噪隔绝在外。每段行程均由身着制服的专业司机驾驶,滑动车门让酒店及场地抵达轻松自如。对于既想要商务车空间、又追求旗舰级工艺的商务人士、名流及贵宾团而言,猎鹰版正是车队中的标志之选。",
      fr: "La Mercedes-Benz V250 Falcon Edition part d'un van de luxe déjà abouti et en reconstruit l'habitacle en salon privé de classe affaires. Des sièges capitaine inclinables individuels en cuir matelassé remplacent les banquettes ordinaires, chacun avec ses propres accoudoirs et de la place pour s'étirer, si bien que les invités arrivent reposés, que le trajet traverse la ville ou tout l'émirat. Un écran de divertissement au plafond, un éclairage d'ambiance et des rideaux d'intimité pleine hauteur transforment la cabine en salle de réunion mobile ou en refuge tranquille — idéal pour les appels confidentiels, le travail entre deux rendez-vous, ou simplement se détendre loin de la rue. Une console réfrigérée garde les rafraîchissements au frais, le Wi-Fi embarqué et la recharge USB gardent chacun connecté, et l'insonorisation de l'habitacle laisse le bruit de la route à sa place. Chaque trajet est assuré par un chauffeur professionnel en uniforme, avec un accès par portes coulissantes qui rend les arrivées aux hôtels et lieux d'événements sans effort. Pour les dirigeants, célébrités et délégations VIP qui veulent l'espace d'un van avec la finition d'un porte-étendard, la Falcon Edition est le véhicule phare de la flotte.",
      de: "Der Mercedes-Benz V250 Falcon Edition nimmt einen bereits vollendeten Luxus-Van und baut das Interieur zu einer privaten Business-Class-Lounge um. Einzelne verstellbare Captain-Seats aus Steppleder ersetzen gewöhnliche Sitzbänke, jeder mit eigenen Armlehnen und Platz zum Ausstrecken, sodass Gäste ausgeruht ankommen — ob die Fahrt durch die Stadt oder durch das ganze Emirat führt. Ein deckenmontierter Entertainment-Bildschirm, Ambientebeleuchtung und bodenlange Sichtschutzvorhänge verwandeln die Kabine in einen mobilen Besprechungsraum oder einen ruhigen Rückzugsort — ideal für vertrauliche Anrufe, Arbeiten zwischen Terminen oder einfach zum Entspannen abseits der Straße. Eine gekühlte Konsole hält Erfrischungen kalt, WLAN an Bord und USB-Laden halten alle verbunden, und die umgebende Kabinendämmung lässt den Fahrgeräuschen keinen Raum. Jede Fahrt wird von einem uniformierten Profi chauffiert, mit Schiebetürzugang, der Ankünfte an Hotels und Veranstaltungsorten mühelos macht. Für Führungskräfte, Prominente und VIP-Delegationen, die den Raum eines Vans mit der Verarbeitung eines Flaggschiffs wollen, ist die Falcon Edition das Statement-Fahrzeug der Flotte.",
    },
    passengers: 7,
    luggage: 6,
    idealFor: {
      en: "VIP groups & executive travel",
      ar: "مجموعات كبار الشخصيات وسفر رجال الأعمال",
      ru: "VIP-группы и деловые поездки",
      zh: "贵宾团体与商务出行",
      fr: "Groupes VIP et voyages d'affaires",
      de: "VIP-Gruppen & Geschäftsreisen",
    },
    features: {
      en: [
      ...
      ar: [
        "مقاعد فردية قابلة للاستلقاء",
        "شاشة ترفيه مثبتة في السقف",
        "ستائر خصوصية بطول كامل",
        "إضاءة محيطية للمقصورة",
        "وحدة وسطى مبردة ومرطبات",
        "شبكة واي فاي وشحن USB على متن السيارة",
      ],
      ru: [
        "Отдельные раскладывающиеся капитанские кресла",
        "Потолочный развлекательный экран",
        "Шторы во всю высоту",
        "Атмосферная подсветка салона",
        "Охлаждаемая консоль и напитки",
      ...
      fr: [
        "Sièges capitaine inclinables individuels",
        "Écran de divertissement au plafond",
        "Rideaux d'intimité pleine hauteur",
        "Éclairage d'ambiance de l'habitacle",
        "Console réfrigérée et rafraîchissements",
        "Wi-Fi embarqué et recharge USB",
      ],
      de: [
        "Einzelne verstellbare Captain-Seats",
        "Deckenmontierter Entertainment-Bildschirm",
        "Bodenlange Sichtschutzvorhänge",
        "Ambientebeleuchtung im Innenraum",
        "Gekühlte Konsole & Erfrischungen",
    ...
    whyChoose: {
      ...
      ar: [
        "مقصورة خاصة بدرجة رجال الأعمال على الطريق لكبار الشخصيات",
        "مقاعد فردية قابلة للاستلقاء — تصل مرتاحًا من أي مسافة",
        "ستائر الخصوصية تبقي المحادثات السرية خاصة",
        "الحافلة المميزة لرجال الأعمال والمشاهير ووفود كبار الشخصيات",
      ],
      ru: [
        "Приватный салон бизнес-класса на колёсах для VIP-гостей",
        "Отдельные раскладывающиеся кресла — прибывайте отдохнувшими на любом расстоянии",
        "Шторы сохраняют конфиденциальность разговоров",
        "Знаковый вэн для руководителей, знаменитостей и VIP-делегаций",
      ],
      zh: [
        "为贵宾打造的移动私密商务舱",
        "独立可躺座椅——无论路途远近皆能舒适抵达",
      ...
      fr: [
        "Une cabine privée de classe affaires sur roues pour invités VIP",
        "Sièges inclinables individuels — arrivez reposé quelle que soit la distance",
        "Les rideaux d'intimité préservent la confidentialité des conversations",
        "Le van phare pour dirigeants, célébrités et délégations VIP",
      ],
      de: [
        "Eine private Business-Class-Kabine auf Rädern für VIP-Gäste",
        "Einzelne verstellbare Sitze — ausgeruht ankommen, egal wie weit",
        "Sichtschutzvorhänge halten vertrauliche Gespräche privat",
        "Der Statement-Van für Führungskräfte, Prominente und VIP-Delegationen",
      ],
    },
    faqs: [
      {
        question: {
          en: "What makes the V250 Falcon Edition different from the standard V-Class?",
          ar: "ما الذي يميز V250 فالكون إديشن عن V-Class القياسية؟",
          ru: "Чем V250 Falcon Edition отличается от стандартного V-Class?",
          zh: "V250猎鹰版与标准V级有何不同?",
          fr: "Qu'est-ce qui distingue la V250 Falcon Edition de la Classe V standard ?",
          de: "Was unterscheidet den V250 Falcon Edition von der Standard-V-Klasse?",
        },
        answer: {
          en: "The Falcon Edition is a bespoke VIP conversion — individual reclining captain's chairs, a ceiling entertainment screen, privacy curtains and ambient lighting turn the cabin into a private business-class lounge rather than standard van seating.",
          ar: "فالكون إديشن هي تحويل خاص لكبار الشخصيات — مقاعد فردية قابلة للاستلقاء وشاشة ترفيه سقفية وستائر خصوصية وإضاءة محيطية تحوّل المقصورة إلى صالة خاصة بدرجة رجال الأعمال بدلاً من مقاعد الحافلة القياسية.",
          ru: "Falcon Edition — это эксклюзивная VIP-переделка: отдельные раскладывающиеся капитанские кресла, потолочный развлекательный экран, шторы и атмосферная подсветка превращают салон в приватный лаундж бизнес-класса вместо стандартных сидений вэна.",
          zh: "猎鹰版是定制的贵宾改装——独立可躺式座椅、车顶娱乐屏幕、隐私窗帘及氛围灯光将座舱化为私密商务舱,而非标准商务车座椅。",
          fr: "La Falcon Edition est une transformation VIP sur mesure — sièges capitaine inclinables individuels, écran de divertissement au plafond, rideaux d'intimité et éclairage d'ambiance transforment la cabine en salon privé de classe affaires plutôt qu'en sièges de van standard.",
          de: "Die Falcon Edition ist ein maßgefertigter VIP-Umbau — einzelne verstellbare Captain-Seats, ein Decken-Entertainment-Bildschirm, Sichtschutzvorhänge und Ambientebeleuchtung verwandeln die Kabine in eine private Business-Class-Lounge statt Standard-Van-Bestuhlung.",
        },
      },
      {
        question: {
          en: "Is the V250 Falcon Edition good for airport VIP transfers?",
          ar: "هل تناسب V250 فالكون إديشن نقل كبار الشخصيات من المطار؟",
          ru: "Подходит ли V250 Falcon Edition для VIP-трансферов из аэропорта?",
          zh: "V250猎鹰版是否适合机场贵宾接送?",
          fr: "La V250 Falcon Edition convient-elle aux transferts VIP aéroport ?",
          de: "Ist der V250 Falcon Edition gut für VIP-Flughafentransfers geeignet?",
        },
        answer: {
          en: "Yes — it's a favourite for VIP arrivals at DXB and DWC, with flight tracking, a meet-and-greet chauffeur, and a private cabin where guests can settle in the moment they land.",
          ar: "نعم — إنها الخيار المفضل لوصول كبار الشخصيات إلى مطار دبي الدولي ومطار آل مكتوم، مع تتبع الرحلات وسائق للاستقبال ومقصورة خاصة يستقر فيها الضيوف لحظة هبوطهم.",
          ru: "Да — это фаворит для VIP-прибытий в DXB и DWC: отслеживание рейса, водитель со встречей у выхода и приватный салон, где гости устраиваются сразу после посадки.",
          zh: "适合——它是DXB与DWC机场贵宾抵达的热门之选,配航班追踪、专人接机司机,以及宾客落地即可安顿的私密座舱。",
          fr: "Oui — c'est un favori pour les arrivées VIP à DXB et DWC, avec suivi de vol, chauffeur d'accueil et une cabine privée où les invités s'installent dès l'atterrissage.",
          de: "Ja — er ist ein Favorit für VIP-Ankünfte am DXB und DWC, mit Flugverfolgung, einem Meet-and-Greet-Chauffeur und einer privaten Kabine, in der sich Gäste sofort nach der Landung einrichten können.",
        },
      },
      {
        question: {
          en: "How many passengers does the V250 Falcon Edition seat?",
          ar: "كم عدد الركاب الذين تتسع لهم V250 فالكون إديشن؟",
          ru: "Сколько пассажиров вмещает V250 Falcon Edition?",
          zh: "V250猎鹰版可容纳多少乘客?",
          fr: "Combien de passagers la V250 Falcon Edition peut-elle accueillir ?",
          de: "Wie viele Passagiere fasst der V250 Falcon Edition?",
        },
        answer: {
          en: "The Falcon Edition seats up to 7 guests in its VIP lounge configuration, with a dedicated luggage area — ideal for executive groups and VIP delegations travelling together.",
          ar: "تتسع فالكون إديشن لما يصل إلى 7 ضيوف في تكوين صالة كبار الشخصيات، مع منطقة أمتعة مخصصة — مثالية لمجموعات رجال الأعمال ووفود كبار الشخصيات المسافرين معًا.",
          ru: "Falcon Edition вмещает до 7 гостей в VIP-конфигурации лаунджа, с отдельной зоной для багажа — идеально для деловых групп и VIP-делегаций, путешествующих вместе.",
          zh: "猎鹰版在其贵宾休息室配置下最多可容纳7位宾客,并设专属行李区——非常适合共同出行的商务团体及贵宾团。",
          fr: "La Falcon Edition accueille jusqu'à 7 invités dans sa configuration salon VIP, avec un espace bagages dédié — idéale pour les groupes d'affaires et délégations VIP voyageant ensemble.",
          de: "Die Falcon Edition bietet in ihrer VIP-Lounge-Konfiguration Platz für bis zu 7 Gäste, mit einem eigenen Gepäckbereich — ideal für gemeinsam reisende Führungsgruppen und VIP-Delegationen.",
        },
      },
    ],
  },
