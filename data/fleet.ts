...
export const FLEET: FleetVehicle[] = [
  {
    ...
    images: [
      {
        src: "/images/fleet/mercedes-maybach-s-class/1.png",
        alt: {
          en: "Mercedes-Maybach S-Class front three-quarter exterior view parked at a modern villa at sunset",
          ar: "منظر خارجي أمامي جانبي لسيارة مرسيدس مايباخ S-Class متوقفة عند فيلا عصرية عند الغروب",
          ru: "Вид спереди сбоку на Mercedes-Maybach S-Class, припаркованный у современной виллы на закате",
          zh: "梅赛德斯迈巴赫S级前四分之三视角外观,停靠在现代别墅前,夕阳西下",
          fr: "Vue extérieure avant trois-quarts de la Mercedes-Maybach Classe S garée devant une villa moderne au coucher du soleil",
          de: "Vorderansicht der Mercedes-Maybach S-Klasse von schräg vorne, geparkt vor einer modernen Villa bei Sonnenuntergang",
        },
      },
      {
        src: "/images/fleet/mercedes-maybach-s-class/2.png",
        alt: {
          en: "Mercedes-Maybach S-Class rear passenger seating with diamond-quilted leather and privacy curtains",
          ar: "مقاعد الركاب الخلفية في مرسيدس مايباخ S-Class بجلد مبطن على شكل ماسي وستائر خصوصية",
          ru: "Задние пассажирские сиденья Mercedes-Maybach S-Class с ромбовидной стёжкой кожи и шторками приватности",
          zh: "梅赛德斯迈巴赫S级后排座椅,采用菱形绗缝真皮及隐私窗帘",
          fr: "Sièges arrière de la Mercedes-Maybach Classe S en cuir matelassé en losanges avec rideaux d'intimité",
          de: "Rücksitze der Mercedes-Maybach S-Klasse mit rautenförmig gestepptem Leder und Sichtschutzvorhängen",
        },
      },
      {
        src: "/images/fleet/mercedes-maybach-s-class/3.png",
        alt: {
          en: "Mercedes-Maybach S-Class rear cabin detail with illuminated Maybach emblem and ambient lighting",
          ar: "تفاصيل المقصورة الخلفية لمرسيدس مايباخ S-Class مع شعار مايباخ المضيء والإضاءة المحيطية",
          ru: "Деталь заднего салона Mercedes-Maybach S-Class с подсвеченной эмблемой Maybach и атмосферной подсветкой",
          zh: "梅赛德斯迈巴赫S级后舱细节,配有发光迈巴赫标志及氛围灯光",
          fr: "Détail de l'habitacle arrière de la Mercedes-Maybach Classe S avec emblème Maybach illuminé et éclairage d'ambiance",
          de: "Detailansicht der hinteren Kabine der Mercedes-Maybach S-Klasse mit beleuchtetem Maybach-Emblem und Ambientebeleuchtung",
        },
      },
    ],
  ...
  },
  {
    ...
    images: [
      {
        src: "/images/fleet/rolls-royce-phantom/1.png",
        alt: {
          en: "Rolls-Royce Phantom Extended Wheelbase front three-quarter exterior view in a marble-floored showroom",
          ar: "منظر خارجي أمامي جانبي لرولز رويس فانتوم الجذع الطويل في صالة عرض ذات أرضية رخامية",
          ru: "Вид спереди сбоку на Rolls-Royce Phantom Extended Wheelbase в шоуруме с мраморным полом",
          zh: "劳斯莱斯幻影加长版前四分之三视角外观,置身于大理石地面展厅之中",
          fr: "Vue extérieure avant trois-quarts de la Rolls-Royce Phantom Extended Wheelbase dans un showroom au sol en marbre",
          de: "Vorderansicht des Rolls-Royce Phantom Extended Wheelbase von schräg vorne in einem Showroom mit Marmorboden",
        },
      },
      {
        src: "/images/fleet/rolls-royce-phantom/2.png",
        alt: {
          en: "Rolls-Royce Phantom rear cabin with starlight headliner and embroidered Rolls-Royce headrests",
          ar: "المقصورة الخلفية لرولز رويس فانتوم بسقف النجوم المضيء ومساند رأس مطرزة بشعار رولز رويس",
          ru: "Задний салон Rolls-Royce Phantom со звёздным потолком и вышитыми подголовниками Rolls-Royce",
          zh: "劳斯莱斯幻影后舱,配有星空顶棚及绣有劳斯莱斯标志的头枕",
          fr: "Habitacle arrière de la Rolls-Royce Phantom avec ciel étoilé et appuie-têtes brodés Rolls-Royce",
          de: "Fondkabine des Rolls-Royce Phantom mit Sternenhimmel-Dachhimmel und bestickten Rolls-Royce-Kopfstützen",
        },
      },
      {
        src: "/images/fleet/rolls-royce-phantom/3.webp",
        alt: {
          en: "Rolls-Royce Phantom rear armrest detail with crystal glasses and decanter",
          ar: "تفاصيل مسند الذراع الخلفي في رولز رويس فانتوم مع كؤوس بلورية ودورق",
          ru: "Деталь заднего подлокотника Rolls-Royce Phantom с хрустальными бокалами и графином",
          zh: "劳斯莱斯幻影后排扶手细节,配水晶杯与醒酒器",
          fr: "Détail de l'accoudoir arrière de la Rolls-Royce Phantom avec verres en cristal et carafe",
          de: "Detailansicht der hinteren Armlehne des Rolls-Royce Phantom mit Kristallgläsern und Karaffe",
        },
      },
    ],
  ...
  },
  {
    ...
    images: [
      {
        src: "/images/fleet/mercedes-s-class/1.png",
        alt: {
          en: "Mercedes-Benz S-Class front three-quarter exterior view with the Burj Khalifa skyline at dusk",
          ar: "منظر خارجي أمامي جانبي لمرسيدس S-Class مع أفق برج خليفة عند الغسق",
          ru: "Вид спереди сбоку на Mercedes-Benz S-Class на фоне горизонта с Бурдж-Халифа в сумерках",
          zh: "梅赛德斯S级前四分之三视角外观,背景为黄昏中的哈利法塔天际线",
          fr: "Vue extérieure avant trois-quarts de la Mercedes-Benz Classe S avec la skyline du Burj Khalifa au crépuscule",
          de: "Vorderansicht der Mercedes-Benz S-Klasse von schräg vorne mit der Burj-Khalifa-Skyline in der Dämmerung",
        },
      },
      {
        src: "/images/fleet/mercedes-s-class/2.jpg",
        alt: {
          en: "Mercedes-Benz S-Class rear cabin with panoramic sunroof and beige leather seating",
          ar: "المقصورة الخلفية لمرسيدس S-Class بفتحة سقف بانورامية ومقاعد جلدية بيج",
          ru: "Задний салон Mercedes-Benz S-Class с панорамным люком и бежевой кожаной обивкой",
          zh: "梅赛德斯S级后舱,配全景天窗及米色真皮座椅",
          fr: "Habitacle arrière de la Mercedes-Benz Classe S avec toit panoramique et sièges en cuir beige",
          de: "Fondkabine der Mercedes-Benz S-Klasse mit Panorama-Schiebedach und beigefarbenen Ledersitzen",
        },
      },
      {
        src: "/images/fleet/mercedes-s-class/3.jpg",
        alt: {
          en: "Mercedes-Benz S-Class rear passenger seating with reclining headrests and privacy shade",
          ar: "مقاعد الركاب الخلفية في مرسيدس S-Class بمساند رأس قابلة للإمالة وستارة خصوصية",
          ru: "Задние пассажирские сиденья Mercedes-Benz S-Class с откидными подголовниками и шторкой приватности",
          zh: "梅赛德斯S级后排座椅,配可调节头枕及隐私遮阳帘",
          fr: "Sièges arrière de la Mercedes-Benz Classe S avec appuie-têtes inclinables et pare-soleil d'intimité",
          de: "Rücksitze der Mercedes-Benz S-Klasse mit verstellbaren Kopfstützen und Sichtschutzrollo",
        },
      },
      {
        src: "/images/fleet/mercedes-s-class/4.jpg",
        alt: {
          en: "Mercedes-Benz S-Class driver's cockpit with digital instrument cluster and steering wheel controls",
          ar: "مقصورة القيادة في مرسيدس S-Class بلوحة عدادات رقمية وأزرار تحكم على المقود",
          ru: "Кабина водителя Mercedes-Benz S-Class с цифровой приборной панелью и органами управления на руле",
          zh: "梅赛德斯S级驾驶舱,配数字仪表盘及方向盘控制按键",
          fr: "Poste de conduite de la Mercedes-Benz Classe S avec instrumentation numérique et commandes au volant",
          de: "Cockpit der Mercedes-Benz S-Klasse mit digitalem Kombiinstrument und Lenkradbedienelementen",
        },
      },
    ],
  ...
  },
  {
    ...
    images: [
      {
        src: "/images/fleet/range-rover-autobiography/1.webp",
        alt: {
          en: "Range Rover Autobiography front three-quarter exterior view outside a modern building",
          ar: "منظر خارجي أمامي جانبي لرينج روفر أوتوبيوغرافي خارج مبنى عصري",
          ru: "Вид спереди сбоку на Range Rover Autobiography у современного здания",
          zh: "揽胜Autobiography前四分之三视角外观,置身于现代建筑之外",
          fr: "Vue extérieure avant trois-quarts de la Range Rover Autobiography devant un bâtiment moderne",
          de: "Vorderansicht des Range Rover Autobiography von schräg vorne vor einem modernen Gebäude",
        },
      },
      {
        src: "/images/fleet/range-rover-autobiography/2.webp",
        alt: {
          en: "Range Rover Autobiography rear executive seating with reclining seats and rear entertainment screens",
          ar: "مقاعد تنفيذية خلفية في رينج روفر أوتوبيوغرافي بمقاعد قابلة للإمالة وشاشات ترفيه خلفية",
          ru: "Задние представительские сиденья Range Rover Autobiography с откидными сиденьями и задними развлекательными экранами",
          zh: "揽胜Autobiography后排行政座椅,配可躺式座椅及后排娱乐屏幕",
          fr: "Sièges executive arrière de la Range Rover Autobiography avec sièges inclinables et écrans de divertissement arrière",
          de: "Hintere Executive-Sitze des Range Rover Autobiography mit verstellbaren Sitzen und hinteren Entertainment-Bildschirmen",
        },
      },
      {
        src: "/images/fleet/range-rover-autobiography/3.png",
        alt: {
          en: "Range Rover Autobiography dashboard and steering wheel detail",
          ar: "تفاصيل لوحة القيادة والمقود في رينج روفر أوتوبيوغرافي",
          ru: "Деталь приборной панели и рулевого колеса Range Rover Autobiography",
          zh: "揽胜Autobiography仪表盘及方向盘细节",
          fr: "Détail du tableau de bord et du volant de la Range Rover Autobiography",
          de: "Detailansicht von Armaturenbrett und Lenkrad des Range Rover Autobiography",
        },
      },
      {
        src: "/images/fleet/range-rover-autobiography/4.jpg",
        alt: {
          en: "Range Rover Autobiography driver's seat and dashboard view",
          ar: "منظر مقعد السائق ولوحة القيادة في رينج روفر أوتوبيوغرافي",
          ru: "Вид на водительское сиденье и приборную панель Range Rover Autobiography",
          zh: "揽胜Autobiography驾驶座及仪表盘视角",
          fr: "Vue du siège conducteur et du tableau de bord de la Range Rover Autobiography",
          de: "Ansicht von Fahrersitz und Armaturenbrett des Range Rover Autobiography",
        },
      },
    ],
  ...
  },
  {
    ...
    images: [
      {
        src: "/images/fleet/cadillac-escalade/1.png",
        alt: {
          en: "Cadillac Escalade ESV front three-quarter exterior view outside a modern glass building",
          ar: "منظر خارجي أمامي جانبي لكاديلاك إسكاليد ESV خارج مبنى زجاجي عصري",
          ru: "Вид спереди сбоку на Cadillac Escalade ESV у современного здания со стеклянным фасадом",
          zh: "凯迪拉克凯雷德ESV前四分之三视角外观,置身现代玻璃建筑之外",
          fr: "Vue extérieure avant trois-quarts de la Cadillac Escalade ESV devant un bâtiment moderne en verre",
          de: "Vorderansicht des Cadillac Escalade ESV von schräg vorne vor einem modernen Glasgebäude",
        },
      },
      {
        src: "/images/fleet/cadillac-escalade/2.jpg",
        alt: {
          en: "Cadillac Escalade ESV side profile exterior view",
          ar: "منظر خارجي جانبي لكاديلاك إسكاليد ESV",
          ru: "Вид сбоку на Cadillac Escalade ESV",
          zh: "凯迪拉克凯雷德ESV侧面外观视图",
          fr: "Vue latérale extérieure de la Cadillac Escalade ESV",
          de: "Seitenansicht des Cadillac Escalade ESV",
        },
      },
      {
        src: "/images/fleet/cadillac-escalade/3.jpg",
        alt: {
          en: "Cadillac Escalade ESV third-row seating and rear cabin",
          ar: "مقاعد الصف الثالث والمقصورة الخلفية في كاديلاك إسكاليد ESV",
          ru: "Сиденья третьего ряда и задний салон Cadillac Escalade ESV",
          zh: "凯迪拉克凯雷德ESV第三排座椅及后舱",
          fr: "Sièges de troisième rangée et habitacle arrière de la Cadillac Escalade ESV",
          de: "Dritte Sitzreihe und Fondkabine des Cadillac Escalade ESV",
        },
      },
      {
        src: "/images/fleet/cadillac-escalade/4.jpg",
        alt: {
          en: "Cadillac Escalade ESV second-row captain's chairs and cabin interior",
          ar: "مقاعد الصف الثاني الفردية والمقصورة الداخلية في كاديلاك إسكاليد ESV",
          ru: "Капитанские кресла второго ряда и салон Cadillac Escalade ESV",
          zh: "凯迪拉克凯雷德ESV第二排独立座椅及座舱内饰",
          fr: "Sièges capitaine de deuxième rangée et intérieur de l'habitacle de la Cadillac Escalade ESV",
          de: "Captain-Seats der zweiten Sitzreihe und Kabineninterieur des Cadillac Escalade ESV",
        },
      },
    ],
  ...
  },
  {
    ...
    images: [
      {
        src: "/images/fleet/mercedes-v-class/1.png",
        alt: {
          en: "Mercedes V-Class front three-quarter exterior view along Dubai Marina with the Burj Khalifa in the background",
          ar: "منظر خارجي أمامي جانبي لمرسيدس V-Class على طول مرسى دبي مع برج خليفة في الخلفية",
          ru: "Вид спереди сбоку на Mercedes V-Class вдоль Dubai Marina с Бурдж-Халифа на фоне",
          zh: "梅赛德斯V级前四分之三视角外观,沿迪拜码头行驶,背景为哈利法塔",
          fr: "Vue extérieure avant trois-quarts de la Mercedes Classe V le long de Dubai Marina avec le Burj Khalifa en arrière-plan",
          de: "Vorderansicht der Mercedes V-Klasse von schräg vorne entlang der Dubai Marina mit dem Burj Khalifa im Hintergrund",
        },
      },
      {
        src: "/images/fleet/mercedes-v-class/2.jpg",
        alt: {
          en: "Mercedes V-Class rear passenger cabin with captain's chairs",
          ar: "مقصورة الركاب الخلفية في مرسيدس V-Class بمقاعد فردية",
          ru: "Задний пассажирский салон Mercedes V-Class с капитанскими креслами",
          zh: "梅赛德斯V级后排乘客舱,配独立座椅",
          fr: "Habitacle arrière de la Mercedes Classe V avec sièges capitaine",
          de: "Fondkabine der Mercedes V-Klasse mit Captain-Seats",
        },
      },
      {
        src: "/images/fleet/mercedes-v-class/3.jpg",
        alt: {
          en: "Mercedes V-Class rear luggage compartment loaded with suitcases",
          ar: "حجيرة الأمتعة الخلفية في مرسيدس V-Class محملة بحقائب السفر",
          ru: "Задний багажный отсек Mercedes V-Class, загруженный чемоданами",
          zh: "梅赛德斯V级后备行李厢,装满行李箱",
          fr: "Compartiment à bagages arrière de la Mercedes Classe V chargé de valises",
          de: "Hinterer Gepäckraum der Mercedes V-Klasse, beladen mit Koffern",
        },
      },
    ],
  ...
  },
  {
    ...
    images: [
      {
        src: "/images/fleet/bmw-7-series/1.jpg",
        alt: {
          en: "BMW 7 Series front three-quarter exterior view with illuminated grille against the Dubai skyline at dusk",
          ar: "منظر خارجي أمامي جانبي لبي إم دبليو الفئة 7 بشبك أمامي مضيء مقابل أفق دبي عند الغسق",
          ru: "Вид спереди сбоку на BMW 7 Series с подсвеченной решёткой радиатора на фоне горизонта Дубая в сумерках",
          zh: "宝马7系前四分之三视角外观,发光进气格栅映衬迪拜天际线,时值黄昏",
          fr: "Vue extérieure avant trois-quarts de la BMW Série 7 avec calandre illuminée sur la skyline de Dubaï au crépuscule",
          de: "Vorderansicht des BMW 7er von schräg vorne mit beleuchtetem Kühlergrill vor der Dubai-Skyline in der Dämmerung",
        },
      },
      {
        src: "/images/fleet/bmw-7-series/2.png",
        alt: {
          en: "BMW 7 Series rear seating with quilted leather upholstery",
          ar: "مقاعد خلفية في بي إم دبليو الفئة 7 بتنجيد جلدي مبطن",
          ru: "Задние сиденья BMW 7 Series со стёганой кожаной обивкой",
          zh: "宝马7系后排座椅,绗缝真皮内饰",
          fr: "Sièges arrière de la BMW Série 7 avec sellerie en cuir matelassé",
          de: "Rücksitze des BMW 7er mit gestepptem Lederbezug",
        },
      },
      {
        src: "/images/fleet/bmw-7-series/3.jpg",
        alt: {
          en: "BMW 7 Series rear seating with tan leather upholstery and wood trim",
          ar: "مقاعد خلفية في بي إم دبليو الفئة 7 بتنجيد جلدي بني فاتح وتشطيبات خشبية",
          ru: "Задние сиденья BMW 7 Series с бежевой кожаной обивкой и деревянной отделкой",
          zh: "宝马7系后排座椅,棕褐色真皮内饰配木质装饰",
          fr: "Sièges arrière de la BMW Série 7 avec sellerie en cuir havane et finitions bois",
          de: "Rücksitze des BMW 7er mit hellbraunem Lederbezug und Holzzierleisten",
        },
      },
      {
        src: "/images/fleet/bmw-7-series/4.jpg",
        alt: {
          en: "BMW 7 Series dashboard with dual curved digital displays",
          ar: "لوحة قيادة بي إم دبليو الفئة 7 بشاشتين رقميتين منحنيتين",
          ru: "Приборная панель BMW 7 Series с двумя изогнутыми цифровыми дисплеями",
          zh: "宝马7系仪表盘,配双联曲面数字显示屏",
          fr: "Tableau de bord de la BMW Série 7 avec double écran numérique incurvé",
          de: "Armaturenbrett des BMW 7er mit gebogenem Doppel-Digitaldisplay",
        },
      },
    ],
    name: "BMW 7 Series",
  ...
  },
  {
    ...
    images: [
      {
        src: "/images/fleet/lexus-es-300h/1.png",
        alt: {
          en: "Lexus ES 300h front three-quarter exterior view with the Dubai skyline and Burj Khalifa in the background",
          ar: "منظر خارجي أمامي جانبي لليكزس ES 300h مع أفق دبي وبرج خليفة في الخلفية",
          ru: "Вид спереди сбоку на Lexus ES 300h на фоне горизонта Дубая и Бурдж-Халифа",
          zh: "雷克萨斯ES 300h前四分之三视角外观,背景为迪拜天际线及哈利法塔",
          fr: "Vue extérieure avant trois-quarts de la Lexus ES 300h avec la skyline de Dubaï et le Burj Khalifa en arrière-plan",
          de: "Vorderansicht des Lexus ES 300h von schräg vorne mit der Dubai-Skyline und dem Burj Khalifa im Hintergrund",
        },
      },
      {
        src: "/images/fleet/lexus-es-300h/2.jpg",
        alt: {
          en: "Lexus ES 300h rear seating with tan leather upholstery",
          ar: "مقاعد خلفية في ليكزس ES 300h بتنجيد جلدي بني فاتح",
          ru: "Задние сиденья Lexus ES 300h с бежевой кожаной обивкой",
          zh: "雷克萨斯ES 300h后排座椅,棕褐色真皮内饰",
          fr: "Sièges arrière de la Lexus ES 300h avec sellerie en cuir havane",
          de: "Rücksitze des Lexus ES 300h mit hellbraunem Lederbezug",
        },
      },
      {
        src: "/images/fleet/lexus-es-300h/3.jpg",
        alt: {
          en: "Lexus ES 300h rear seat detail with center armrest",
          ar: "تفاصيل المقعد الخلفي في ليكزس ES 300h مع مسند الذراع الأوسط",
          ru: "Деталь заднего сиденья Lexus ES 300h с центральным подлокотником",
          zh: "雷克萨斯ES 300h后排座椅细节,配中央扶手",
          fr: "Détail du siège arrière de la Lexus ES 300h avec accoudoir central",
          de: "Detailansicht des Rücksitzes des Lexus ES 300h mit mittlerer Armlehne",
        },
      },
    ],
    name: "Lexus ES 300h",
  ...
  },
  {
    ...
    images: [
      {
        src: "/images/fleet/rolls-royce-cullinan-mansory/1.png",
        alt: {
          en: "Rolls-Royce Cullinan Mansory front three-quarter exterior view in a custom turquoise widebody finish",
          ar: "منظر خارجي أمامي جانبي لرولز رويس كولينان مانسوري بطلاء عريض مخصص باللون الفيروزي",
          ru: "Вид спереди сбоку на Rolls-Royce Cullinan Mansory в кастомной бирюзовой отделке широкого кузова",
          zh: "劳斯莱斯库里南Mansory版前四分之三视角外观,定制绿松石色宽体涂装",
          fr: "Vue extérieure avant trois-quarts de la Rolls-Royce Cullinan Mansory dans une finition large sur mesure turquoise",
          de: "Vorderansicht des Rolls-Royce Cullinan Mansory von schräg vorne in individueller türkisfarbener Breitbau-Lackierung",
        },
      },
      {
        src: "/images/fleet/rolls-royce-cullinan-mansory/2.png",
        alt: {
          en: "Rolls-Royce Cullinan Mansory front-on exterior view showing the widebody kit and grille",
          ar: "منظر خارجي أمامي لرولز رويس كولينان مانسوري يُظهر طقم الهيكل العريض والشبك الأمامي",
          ru: "Вид спереди на Rolls-Royce Cullinan Mansory с широким кузовным комплектом и решёткой радиатора",
          zh: "劳斯莱斯库里南Mansory版正面外观,展示宽体套件与前格栅",
          fr: "Vue extérieure de face de la Rolls-Royce Cullinan Mansory montrant le kit large et la calandre",
          de: "Frontansicht des Rolls-Royce Cullinan Mansory mit Breitbau-Kit und Kühlergrill",
        },
      },
      {
        src: "/images/fleet/rolls-royce-cullinan-mansory/3.png",
        alt: {
          en: "Rolls-Royce Cullinan Mansory cabin view with matching turquoise leather interior and open doors",
          ar: "منظر داخلي لمقصورة رولز رويس كولينان مانسوري بجلد فيروزي متناسق وأبواب مفتوحة",
          ru: "Вид салона Rolls-Royce Cullinan Mansory с бирюзовой кожаной отделкой в тон и открытыми дверьми",
          zh: "劳斯莱斯库里南Mansory版座舱视图,配同色系绿松石真皮内饰及车门开启状态",
          fr: "Vue de l'habitacle de la Rolls-Royce Cullinan Mansory avec cuir turquoise assorti et portes ouvertes",
          de: "Innenraumansicht des Rolls-Royce Cullinan Mansory mit passendem türkisfarbenem Lederinterieur und geöffneten Türen",
        },
      },
    ],
  ...
  },
  {
    ...
    images: [
      {
        src: "/images/fleet/tesla-model-y/1.png",
        alt: {
          en: "Tesla Model Y front three-quarter exterior view with the Dubai skyline in the background",
          ar: "منظر خارجي أمامي جانبي لتيسلا Model Y مع أفق دبي في الخلفية",
          ru: "Вид спереди сбоку на Tesla Model Y на фоне горизонта Дубая",
          zh: "特斯拉Model Y前四分之三视角外观,背景为迪拜天际线",
          fr: "Vue extérieure avant trois-quarts de la Tesla Model Y avec la skyline de Dubaï en arrière-plan",
          de: "Vorderansicht des Tesla Model Y von schräg vorne mit der Dubai-Skyline im Hintergrund",
        },
      },
      {
        src: "/images/fleet/tesla-model-y/2.jpg",
        alt: {
          en: "Tesla Model Y rear seating with black leather upholstery",
          ar: "مقاعد خلفية في تيسلا Model Y بتنجيد جلدي أسود",
          ru: "Задние сиденья Tesla Model Y с чёрной кожаной обивкой",
          zh: "特斯拉Model Y后排座椅,黑色真皮内饰",
          fr: "Sièges arrière de la Tesla Model Y avec sellerie en cuir noir",
          de: "Rücksitze des Tesla Model Y mit schwarzem Lederbezug",
        },
      },
      {
        src: "/images/fleet/tesla-model-y/3.webp",
        alt: {
          en: "Tesla Model Y interior cabin detail",
          ar: "تفاصيل المقصورة الداخلية لتيسلا Model Y",
          ru: "Деталь салона Tesla Model Y",
          zh: "特斯拉Model Y内饰座舱细节",
          fr: "Détail de l'habitacle intérieur de la Tesla Model Y",
          de: "Detailansicht des Innenraums des Tesla Model Y",
        },
      },
    ],
    name: "Tesla Model Y",
  ...
  },
  {
    ...
    images: [
      {
        src: "/images/fleet/gmc-yukon-elevation/1.png",
        alt: {
          en: "GMC Yukon Elevation front three-quarter exterior view outside a modern illuminated entrance at night",
          ar: "منظر خارجي أمامي جانبي لجي إم سي يوكون إليفيشن عند مدخل حديث مضاء ليلاً",
          ru: "Вид спереди сбоку на GMC Yukon Elevation у современного освещённого входа ночью",
          zh: "GMC育空Elevation版前四分之三视角外观,夜间置身于现代化灯光入口前",
          fr: "Vue extérieure avant trois-quarts du GMC Yukon Elevation devant une entrée moderne illuminée de nuit",
          de: "Vorderansicht des GMC Yukon Elevation von schräg vorne vor einem modernen, beleuchteten Eingang bei Nacht",
        },
      },
      {
        src: "/images/fleet/gmc-yukon-elevation/2.jpg",
        alt: {
          en: "GMC Yukon Elevation front cabin seating with tan leather upholstery",
          ar: "مقاعد المقصورة الأمامية في جي إم سي يوكون إليفيشن بتنجيد جلدي بني فاتح",
          ru: "Передние сиденья GMC Yukon Elevation с бежевой кожаной обивкой",
          zh: "GMC育空Elevation版前排座椅,棕褐色真皮内饰",
          fr: "Sièges avant du GMC Yukon Elevation avec sellerie en cuir havane",
          de: "Vordersitze des GMC Yukon Elevation mit hellbraunem Lederbezug",
        },
      },
      {
        src: "/images/fleet/gmc-yukon-elevation/3.jpg",
        alt: {
          en: "GMC Yukon Elevation third-row and rear seating",
          ar: "مقاعد الصف الثالث والمقاعد الخلفية في جي إم سي يوكون إليفيشن",
          ru: "Третий ряд и задние сиденья GMC Yukon Elevation",
          zh: "GMC育空Elevation版第三排及后排座椅",
          fr: "Troisième rangée et sièges arrière du GMC Yukon Elevation",
          de: "Dritte Sitzreihe und Rücksitze des GMC Yukon Elevation",
        },
      },
    ],
  ...
  },
  {
    ...
    images: [
      {
        src: "/images/fleet/tesla-model-3/1.jpg",
        alt: {
          en: "Tesla Model 3 front three-quarter studio exterior view in white",
          ar: "منظر خارجي أمامي جانبي لتيسلا Model 3 باللون الأبيض في استوديو تصوير",
          ru: "Вид спереди сбоку на белую Tesla Model 3 в студийной съёмке",
          zh: "特斯拉Model 3前四分之三视角外观,白色车身,影棚拍摄",
          fr: "Vue extérieure avant trois-quarts en studio de la Tesla Model 3 blanche",
          de: "Vorderansicht des weißen Tesla Model 3 von schräg vorne im Studio",
        },
      },
      {
        src: "/images/fleet/tesla-model-3/2.webp",
        alt: {
          en: "Tesla Model 3 interior cabin detail",
          ar: "تفاصيل المقصورة الداخلية لتيسلا Model 3",
          ru: "Деталь салона Tesla Model 3",
          zh: "特斯拉Model 3内饰座舱细节",
          fr: "Détail de l'habitacle intérieur de la Tesla Model 3",
          de: "Detailansicht des Innenraums des Tesla Model 3",
        },
      },
      {
        src: "/images/fleet/tesla-model-3/3.jpg",
        alt: {
          en: "Tesla Model 3 rear seating with black leather upholstery",
          ar: "مقاعد خلفية في تيسلا Model 3 بتنجيد جلدي أسود",
          ru: "Задние сиденья Tesla Model 3 с чёрной кожаной обивкой",
          zh: "特斯拉Model 3后排座椅,黑色真皮内饰",
          fr: "Sièges arrière de la Tesla Model 3 avec sellerie en cuir noir",
          de: "Rücksitze des Tesla Model 3 mit schwarzem Lederbezug",
        },
      },
    ],
    name: "Tesla Model 3",
  ...
  },
  {
    ...
    images: [
      {
        src: "/images/fleet/byd-han/1.jpg",
        alt: {
          en: "BYD Han front three-quarter exterior view on a palm-lined Dubai street",
          ar: "منظر خارجي أمامي جانبي لـ BYD Han في شارع مصطف بأشجار النخيل في دبي",
          ru: "Вид спереди сбоку на BYD Han на улице Дубая, обрамлённой пальмами",
          zh: "比亚迪汉前四分之三视角外观,置身棕榈树林立的迪拜街道",
          fr: "Vue extérieure avant trois-quarts de la BYD Han dans une rue de Dubaï bordée de palmiers",
          de: "Vorderansicht des BYD Han von schräg vorne auf einer palmengesäumten Straße in Dubai",
        },
      },
    ],
    name: "BYD Han",
